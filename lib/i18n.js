...
I18n.prototype.extend = function(path){
  return this.clone().load(path)
}
...
I18n.middleware = function middleware(lang,path){
  return function(req,res,next){
    ...
    // register a `t()` helper
    if( app && typeof app.locals == 'function' )
      app.locals({ t: function helper(key,context){ return req.i18n.t(key,context||req.i18n.locale) } });
